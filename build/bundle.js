var app = (function () {
    ...
    class Row extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { class: 3, noGutters: 4, form: 5, id: 0 });
    	}
    }
    ...
    // (57:4) <Button       disabled={disableSearch}       on:click={onSearch}       color="primary"       class="search">
    ...
    function create_default_slot_1(ctx) {
    	...
    	button.$on("click", /*onSearch*/ ctx[2]);
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*disableSearch*/ 2) button_changes.disabled = /*disableSearch*/ ctx[1];
    ...
    function create_default_slot(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, disableSearch*/ 34) {
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, disableSearch, search*/ 35) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*search*/ 1) {
    			 $$invalidate(1, disableSearch = search === "");
    		}
    	};

    	return [search, disableSearch, onSearch, dispatch, input_value_binding];
    }
    ...
    class Joke extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { joke: 0 });
    	}
    }
    ...
    // (77:6) <Button on:click={newRandomJoke} color="danger big-btn">
    function create_default_slot_9(ctx) {
    	let t;

    	return {
    		c() {
    			t = text("Random Dad Joke");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (76:4) <Col md="12" xs="12">
    function create_default_slot_8(ctx) {
    	let current;

    	const button = new Button({
    			props: {
    				color: "danger big-btn",
    				$$slots: { default: [create_default_slot_9] },
    				$$scope: { ctx }
    			}
    		});

    	button.$on("click", /*newRandomJoke*/ ctx[4]);
    ...
    function create_if_block_3$2(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, randomJoke*/ 1026) {
    ...
    function create_default_slot_4$1(ctx) {
    	let current;
    	const joke = new Joke({ props: { joke: /*randomJoke*/ ctx[1] } });
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			const joke_changes = {};
    			if (dirty & /*randomJoke*/ 2) joke_changes.joke = /*randomJoke*/ ctx[1];
    ...
    function create_default_slot_3$1(ctx) {
    	...
    	let if_block = /*randomJoke*/ ctx[1] !== "" && create_if_block_4$1(ctx);
    ...
    function create_if_block$2(ctx) {
    	...
    	let current;
    	let if_block0 = /*jokes*/ ctx[2].length > 0 && create_if_block_2$2(ctx);
    	let if_block1 = /*noJokes*/ ctx[3] && create_if_block_1$2(ctx);
    ...
    // (98:4) {#if jokes.length > 0}
    function create_if_block_2$2(ctx) {
    	let each_blocks = [];
    	let each_1_lookup = new Map();
    	let each_1_anchor;
    	let current;
    	let each_value = /*jokes*/ ctx[2];
    	const get_key = ctx => /*joke*/ ctx[7].id;
    ...
    function create_default_slot_2$2(ctx) {
    	let t;
    	let current;
    	const joke = new Joke({ props: { joke: /*joke*/ ctx[7].joke } });
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			const joke_changes = {};
    			if (dirty & /*jokes*/ 4) joke_changes.joke = /*joke*/ ctx[7].joke;
    			joke.$set(joke_changes);
    		},
    		i(local) {
    			if (current) return;
    ...
    // (99:6) {#each jokes as joke (joke.id)}
    ...
    function create_default_slot_1$2(ctx) {
    	...
    	const joke = new Joke({
    			props: {
    				joke: "No Joke, the joke on you!!! :) try agiain. :)"
    			}
    		});
    ...
    function create_default_slot$2(ctx) {
    	...
    	jokeform.$on("search", /*onSearchJokes*/ ctx[5]);
    	...
    	let if_block0 = /*mode*/ ctx[0] == "random" && create_if_block_3$2(ctx);
    	let if_block1 = /*mode*/ ctx[0] === "search" && create_if_block$2(ctx);
    ...
    function create_fragment$a(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, noJokes, jokes, mode, randomJoke*/ 1039) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		$$invalidate(1, randomJoke = await getRandomJoke());
    	});

    	async function newRandomJoke() {
    		try {
    			$$invalidate(0, mode = "random");
    			$$invalidate(1, randomJoke = "");
    			let joke = await getRandomJoke();
    			await sleep(1000);
    			$$invalidate(1, randomJoke = joke);
    			$$invalidate(2, jokes = []);
    		} catch(e) {
    	...
    	async function onSearchJokes(e) {
    		try {
    			...
    			await sleep(1000);
    			$$invalidate(1, randomJoke = "");
    			$$invalidate(2, jokes = newJokes);
    			$$invalidate(3, noJokes = jokes.length === 0);
    		} catch(e) {
    			alert("There was an error with the server");
    		}
    	}
    	...
    	return [mode, randomJoke, jokes, noJokes, newRandomJoke, onSearchJokes];
    }
